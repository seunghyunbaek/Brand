...
<body style="overflow-x: hidden;">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <form class="form-inline" action="./board/bbs1/total.php#list2" method="get">
                            <!-- 변경 : 토탈검색 장르 -->
                            <input type="hidden" name="genre" value="life">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    ...
                    // <!-- 변경 : 이미지 게시글 장르 -->
                    $query = "select * from bbs1 where genre='life' and regdate between '$weekago' and '$now' and file01!='' order by hit desc limit 4";
    ...
    <div class="container" style="border: 1px solid gray; border-radius: 20px;">
        <div class="row">
            ...
            // 게임장르 상위 10개 가져오기
            // <!-- 변경 : 인기글 장르 -->
            $query = "select * from bbs1 where genre='life' and regdate between '$weekago' and '$now' order by hit desc limit 10";
            if (!$result = mysql_query($query, $connect)) {
                echo "Errno: " . $connect->errno . "\n";
                echo "Error: " . $connect->error . "\n";
            }
    ...
    <div class="container" style="border: 1px solid gray; border-radius: 20px;">
        <div class="row">
            ...
            // <!-- 변경 : 장르 -->
            $query = "select id, sum(hit) as total_hit from bbs1 where regdate between '$weekago' and '$now' and genre='life' group by id order by sum(hit) desc limit 10";
            if (!$result = mysql_query($query, $connect)) {
                echo "Errno: " . $connect->errno . "\n";
                echo "Error: " . $connect->error . "\n";
            }
    ...
    <div class="container" style="height: 257px; overflow-y:overlay; ">
        <div class="row">
            ...
            <!-- 변경 : 장르 -->
            <?php
            $query2 = "select * from bbs1_name where genre='life' order by name"; // desc 내림차순 asc 오름차순
            if (!$result2 = mysql_query($query2, $connect)) {
                echo "Errno: " . $connect->errno . "\n";
                echo "Error: " . $connect->error . "\n";
            }
