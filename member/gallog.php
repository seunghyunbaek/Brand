...
<body style="overflow-x: hidden;">
    ...
    <div class="container">
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item"><a class="nav-link active" href="./gallog.php">갤로그 홈</a></li>
                ...
                <div class="row">
                    <div class="container">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php
                                $query = "select * from bbs1 where user_id='$member[user_id]' order by hit desc limit $view_top"; // desc 내림차순 asc 오름차순
                                $result = mysql_query($query, $connect);
                                $cnt = 1;
