...
<body style="overflow-x: hidden;">
    ...
    <div class="container">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item"><a class="nav-link" href="./gallog2.php">내 게시글</a></li>
            <li class="nav-item"><a class="nav-link active" href="./gallog3.php">내 댓글</a></li>
        ...
        <div class="tab-content">
            <!-- 3번 탭 -->
            <div role="tabpanel" id="tab3" class="tab-pane fadein active">
                <div class="row">
                    <div class="container">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                $query = "select count(*) from bbs1_comment where user_id='$member[user_id]'";
                                mysql_query("set names utf8", $connect);
                                $result = mysql_query($query, $connect);
                                $temp = mysql_fetch_array($result);
                                $total = $temp[0];

                                // $query = "select * from bbs1_comment where user_id='$member[user_id]' order by no desc limit $view_top"; // desc 내림차순 asc 오름차순
                                $query = "select * from bbs1_comment where user_id='$member[user_id]' order by no desc limit $page, $view_total";
                                $result = mysql_query($query, $connect);
                                $cnt = 1;
                                ...
                                while ($data = mysql_fetch_array($result)) {
                                    ...
                                    echo "<td> <div style='white-space: nowrap; width: 400px; overflow: hidden; text-overflow: ellipsis;'> <a href='../board/bbs1/view.php?no=$data[bbs1_no]&id=$data[id]'> $data[memo]";
