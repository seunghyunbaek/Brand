...
<body style="overflow-x: hidden;">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    ...
                    // 이미지가 있는 게시글중 상위 3개만 가져옵니다
                    $query = "select * from bbs1 where genre='game' and regdate between '$weekago' and '$now' and file01!='' order by hit desc limit 4";
                    ...
                    while ($data = mysql_fetch_array($result)) {
                        // echo nl2br("$data[subject]" . "<br>");
                        // echo nl2br("$data[file01]" . "<br>");
    ...
    <div class="container" style="border: 1px solid gray; border-radius: 20px;">
        <div class="row">
            ...
            $game_top_count = 0;
            // 게임장르 상위 10개 가져오기
            $query = "select * from bbs1 where genre='game' and regdate between '$weekago' and '$now' order by hit desc limit 10";
            if (!$result = mysql_query($query, $connect)) {
                echo "Errno: " . $connect->errno . "\n";
                echo "Error: " . $connect->error . "\n";
            }
    ...
    <div class="container" style="border: 1px solid gray; border-radius: 20px;">
        <div class="row">
            ...
            $game_top_count = 0;
            // 게임장르 상위 10개 가져오기
            $query = "select id, sum(hit) as total_hit from bbs1 where regdate between '$weekago' and '$now' and genre='game' group by id order by sum(hit) desc limit 10";
            if (!$result = mysql_query($query, $connect)) {
                echo "Errno: " . $connect->errno . "\n";
                echo "Error: " . $connect->error . "\n";
            }
    ...
    <div class="container" style="height: 257px; overflow-y:overlay; ">
        <div class="row">
            ...
            <?php
            $query2 = "select * from bbs1_name where genre='game' order by name"; // desc 내림차순 asc 오름차순
            if (!$result2 = mysql_query($query2, $connect)) {
                echo "Errno: " . $connect->errno . "\n";
                echo "Error: " . $connect->error . "\n";
            }
            ...
            <!-- <div class="col-md-4">
                <ul class="list-group">
                    <li class="list-group-item"><a href="./board/bbs1/monsterhunter.php">몬스터헌터 갤러리</a></li>
                    <li class="list-group-item"><a href="./board/bbs1/tekken.php">철권 갤러리</a></li>
                    <li class="list-group-item"><a href="./board/bbs1/lol.php">리그 오브 레전드 갤러리</a></li>
                    <li class="list-group-item"><a href="./board/bbs1/elsword.php">엘소드 갤러리</a></li>
                </ul>
            </div>

            <div class="col-md-4">
                <ul class="list-group">
                    <li class="list-group-item"><a href="./board/bbs1/maplestory.php">메이플스토리 갤러리</a></li>
                </ul>
            </div> -->
