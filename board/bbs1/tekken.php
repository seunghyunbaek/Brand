...
<body>
    ...
    // 변경7 : id 경로 변경하기
    $query = "select count(*) from bbs1 where id='tekken'";
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            ...
            <a class="navbar-brand" href="./tekken.php">철권 갤러리</a> 
    ...
    <div class="container">
        <div class="mx-auto; d-block;" style="width:500px; height:auto; margin:20px auto">
            <!-- 변경3 : 갤러리 메인 이미지  -->
            <img class="img-fluid" src="./tekken.png" alt="철권" style="max-height:700px">
        </div>
    </div>
    <!-- 이미지 끝 -->
    <br><br>
    ...
    <div class="container">
        <table class="table table-hover">
            ...
            <tbody>
                ...
                $query = "select * from bbs1 where id='tekken' order by hit desc limit $view_top"; // desc 내림차순 asc 오름차순
                $result = mysql_query($query, $connect);
                $cnt = 1;
    ...
    <div class="container">
        <table class="table table-hover">
            ...
            <tbody>
                ...
                $query = "select * from bbs1 where id='tekken' order by no desc limit $page, $view_total"; // desc 내림차순 asc 오름차순
                if ($_catagory == "title") {
                    $query = "select * from bbs1 where id='tekken' and subject like '%$_search%' order by no desc limit $page, $view_total"; // desc 내림차순 asc 오름차순
                } elseif ($_catagory == "name") {
                    $query = "select * from bbs1 where id='tekken' and name like '%$_search%' order by no desc limit $page, $view_total"; // desc 내림차순 asc 오름차순
                } elseif ($_catagory == "content") {
                    $query = "select * from bbs1 where id='tekken' and story like '%$_search%' order by no desc limit $page, $view_total"; // desc 내림차순 asc 오름차순
                }
    ...
    <div class="container">
        <!-- 변경 6 : 글쓰기 경로 id변경하기  -->
        <button type="button" class="btn btn-primary float-right"><a style="color:white;" href="./write.php?id=tekken&genre=game">글쓰기</a></button>
    ...
    <div class="container">
        <div class="row mx-auto">
            <!-- action의 페이지경로 변경 -->
            <form class="form-inline" style="margin:0 auto;" action="./tekken.php<?php echo '#list2';?>" method="get">
