    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <table class="table">
                    <tbody>
                        <form action="./edit_post.php" name="write" method="post" enctype="multipart/form-data">
                            ...
                            <tr>
                                <td>
                                    제목 : <input type="text" name="subject" style="width:500px; height:30px" value="<?php echo $data['subject']; ?>">
                                </td>
                            </tr>

                            <tr>
                                <td>
                                    <textarea id="ir1" name="story" style="width:100%; height:400px;"><?php echo nl2br($data['story']); ?></textarea>
                                </td>
                            </tr>
                                ...
                                <td>
                                    ...
                                    <div class="filebox bs3-primary preview-image">
                                        ...
                                        if ($data['file01']) {
                                            ?>
                                            <!-- 파일이 있을때 -->
                                            파일 : <?php echo "<font color='#3f6ff8'>" . $data['file01'] . "</font>"; ?>
                                            &nbsp; &nbsp; &nbsp;
                                            <a href="#" onclick="window.open('./file_del.php?no=<?php echo $no; ?>','open','width=450, height=150, top=50, left=5, scrollbars=no, resizable=no')">
                                                <!-- <font color="#ff0000">[삭제]</font> -->
                            ...
                            <tr>
                                <td>
                                    <div style="float:right;">
                                        <input class="btn btn-primary" type="submit" value="수정" onclick="submitContents()">
                                        <input class="btn btn-primary" type="button" value="취소" onclick="history.back(-1);">
                                    </div>
                                </td>
                            </tr>
                        </form>
