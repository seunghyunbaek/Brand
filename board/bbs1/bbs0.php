...
<body>
    ...
    $query = "select count(*) from bbs1 where id='bbs0'";

    if ($_catagory == "title") {
        $query = "select count(*) from bbs1 where subject like '%$_search%' and id='bbs0'";
    } elseif ($_catagory == "name") {
        $query = "select count(*) from bbs1 where name like '%$_search%' and id='bbs0'";
    } elseif ($_catagory == "content") {
        $query = "select count(*) from bbs1 where story like '%$_search%' and id='bbs0'";
    }
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="./bbs0.php">공지사항 갤러리</a>
    ...
    <div class="container">
        <div class="mx-auto; d-block;" style="width:500px; height:auto; margin:20px auto">
            <img class="img-fluid" src="./welcome.png" alt="welcome">
        </div>
    </div>
    <!-- 이미지 끝 -->
    <br><br>
    ...
    <div class="container">
        <table class="table table-hover">
            <caption style="caption-side:top">
                <?php if ($_search == -1) { ?>
                    <h6 id="list2">공지사항 갤러리</h6>
                <?php } else { ?>
                    <h5 id="list2"><strong>공지사항 갤러리 : <?php echo $_search . " 검색결과"; ?></strong></h5>
                <?php } ?>
            </caption>
            <thead>
                <tr>
            ...
            <tbody>
                <?php
                $query = "select * from bbs1 where id='bbs0' order by no desc limit $page, $view_total"; // desc 내림차순 asc 오름차순
                if ($_catagory == "title") {
                    $query = "select * from bbs1 where id='bbs0' and subject like '%$_search%' order by no desc limit $page, $view_total"; // desc 내림차순 asc 오름차순
                } elseif ($_catagory == "name") {
                    $query = "select * from bbs1 where id='bbs0' and name like '%$_search%' order by no desc limit $page, $view_total"; // desc 내림차순 asc 오름차순
                } elseif ($_catagory == "content") {
                    $query = "select * from bbs1 where id='bbs0' and story like '%$_search%' order by no desc limit $page, $view_total"; // desc 내림차순 asc 오름차순
                }
    ...
    <div class="container">
        <?php if ($member['level'] == 1) { ?>
            <button type="button" class="btn btn-primary float-right"><a style="color:white;" href="./write.php?id=bbs0&genre=notice">글쓰기</a></button>
    ...
    <div class="container">
        <div class="row mx-auto">
            <form class="form-inline" style="margin:0 auto;" action="./bbs0.php" method="get">
